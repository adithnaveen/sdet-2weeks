 ...
 *      exists with two columns. Test it with main method provided, and the path
 *      is hard coded, participatns are asked to refractor this path in the
 *      property file and access.
 */
